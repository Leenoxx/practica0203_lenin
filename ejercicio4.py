...
# prefijo-número-extensión donde el prefijo es el código
...
# y muestre por pantalla el número de teléfono sin el
# prefijo y la extensión.

numero = str(input("Introduce un número de teléfono: "))
